...
\begin{abstract}
  ...
  cue in vision applications.
  In this paper, we propose to estimate attitude of \gls{uav} from sky
  information using a polarimetric camera. Theoretically, we provide a
  framework estimating the attitude from the skylight polarized
  patterns. We showcase this formulation on both simulated and real-word data
