...
\begin{figure*}
  ...
  \hspace*{\fill}
  \subfigure[\gls{aop}]{\label{fig:aop-noise-syn}\includegraphics[width=0.22\textwidth,
    height=0.12\textheight]{./content/experiments/figures/aop-noise-01-2.jpg}
    }\hfill
  \subfigure[\gls{dopl}]{\label{fig:dop-noise-syn}\includegraphics[width=0.22\textwidth,
