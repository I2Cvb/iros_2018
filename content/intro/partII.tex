...
Combination of Eq.\,\eqref{Eq:E}~\&~\eqref{Eq:Eproj} and using the
...
\noindent applying vector triplet cross product rule on Eq.\,\eqref{eq:E0EB
  vect-1-1} results.
\begin{equation}
\begin{cases}
...
\label{eq:scal-b-o}
\end{equation}
Using Eq.\,\eqref{eq:3}, the scattering angle $\gamma$, therefore can be
represented as:
\begin{equation}
